...
func (c *NbaStatsClient) LeagueGameLog(fields *LeagueGameLogFields) (*model.Result, error) {
  ...
  // Validate
  err := playerOrTeam.Assert(fields.PlayerOrTeam, true); if err != nil { return nil, err }
  ...
  bytes, err := c.Get(model.FetchConfig{
    ...
    Fields:     &map[string]string{
      ...
      "PlayerOrTeam": playerOrTeam.FromVal(fields.PlayerOrTeam),
